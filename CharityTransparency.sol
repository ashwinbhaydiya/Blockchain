...
contract Charity{
    ...
    AddStaticEntity(1046, "Maharashtra", 4);
    AddStaticEntity(1001, "Mumbai", 5);
    AddStaticEntity(1010, "NaviMumbai", 6);

    AddEntity(1, "Ashwin", 1);
    AddEntity(2, "Lokesh", 2);
    AddEntity(3, "Vishal", 3);

    AddScheme(
        "XYZC",
        "X Y Z Charity",
        "X Y Z C charity ensures your money reaches those who need it",
        1000,
        222222,
    ...
    TransferMoney("XYZC", 1046, 2, 20);  // Money transferred to Lokesh
}
